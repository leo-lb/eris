...
class Client extends EventEmitter {
    ...
    * @arg {String} username The username of the target user
    * @arg {Number} username The discriminator of the target user
    * @returns {Promise}
    */
    addRelationship(username, discriminator) {
        return this.requestHandler.request("POST", Endpoints.USER_RELATIONSHIP("@me"), true, {
            username: username,
